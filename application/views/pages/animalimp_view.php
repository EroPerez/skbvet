                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-xs-8" style="padding:2px; border:1px;"> 
                                        <div class="section row"> 
                                            ...
                                            <!-- <div class="section row"> -->
                                            <div class="col-md-12 col-xs-12">
                                                <div class="section-divider"><span>Importer</span></div>
                                        ...
                                        <div  class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div id="skin-switcher" class="row tray-bin btn-dimmer mb20">
                                                    ...
                                                    <div class="col-xs-12 pln"><a id="listfarm" href="<?= site_url('animalimp') ?>" data-form-skin="success" class="btn btn-info btn-gradient btn-alt btn-block item-active"><i class="glyphicon glyphicon-list"></i> Back to List</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>  
            ...
            <div class="modal-body admin-form" style="max-height:calc(100vh - 210px); overflow-y: auto;">
                ...
                <form  role="form" id="form-order3" method="post" action="/">    
                    <div class="section row" >
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="section-divider"><span class="label label-rounded label-info">Origin</span></div>
                    ...
                    <div class="section row" >
                        <div class="col-md-12">
                            <div class="section-divider"><span>Import Status</span></div>
                            <div class="section mv15">
                                <div class="option-group field">
                                    <label class="option option-primary">
                                        <input name="animalimp_status" id="animalimp_status_im" value="1" type="radio"><span class="radio"></span>New Import
                                    </label>
                                    <label class="option option-primary">
                                        <input name="animalimp_status" id="animalimp_status_rem" value="2" type="radio"><span class="radio"></span>Re Import
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="section row" >
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label for="animalimp_quara_period" class="field prepend-icon">
                                            <input id="animalimp_quara_period" type="text" name="animalimp_quara_period"  class="gui-input">
                                            <label for="animalimp_quara_period" class="field-icon"><i class="fa fa-user"></i></label>
                                        </label> 
                                    </div>
                                    <div class="col-md-6">
                                        <label class="field select">
                                            <select id="animalimp_quarantine_unit" name="animalimp_quarantine_unit" placeholder="Quarantine">
                                                <?php foreach ($unit_time as $key_unit_time => $value_unit_time) { ?>
                                                    <option value="<?php echo $value_unit_time['recn']; ?>"><?php echo $value_unit_time['name']; ?></option>
                                                <?php } ?>
                                            </select><i class="arrow"></i>
                                        </label>
                                    </div>
                    ...
                    <div class="section row" >
                        <div class="col-md-12">
                            ...
                            <label class="field prepend-icon">
                                ...
                                <label for="animalimp_comment" class="field-icon"><i class="imoon imoon-location2"></i></label>
                            </label>
                        </div>
                    </div>
                    <!--end treatment --> 
