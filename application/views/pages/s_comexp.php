...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function back_licence() {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/tradeproducts_backward'; ?>",
            data: {"page": $('#page').val()},
            success: function (e) {
    ...
    function forward_licence() {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/tradeproducts_forward'; ?>",
            data: {"page": $('#page').val()},
            success: function (e) {
                $('#comimp_recn').val(Number(e.tradeproducts[0].recn));
                $('#comimp_licenceNo').val(e.tradeproducts[0].licenceNo);
    ...
    function save_licence() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/tradeproducts_add_edit'; ?>",
            data: {
                "comimp_date": $('#comimp_date').val(),
    ...
    function delete_licence() {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/tradeproducts_delete'; ?>",
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function save_tradeproductsdetails() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/add_tradeproductsdetails'; ?>",
            data: {
                "recntp": $('#recntp').val(),
                "recntpd": $('#recntpd').val(),
                ...
                "edit": c_edit,
                "comimp_sender": $('#comimp_sender').val(),
                "comimp_receiver": $('#comimp_receiver').val()
            },
            success: function (e) {
    ...
    function editar_tradeproductsdetails(idlive) {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/edit_tradeproductsdetails'; ?>",
            ...
            success: function (e) {
                ...
                $('#comimp_sender').val(e[0].consignee_of_sender);
                $('#comimp_receiver').val(e[0].consignee_of_receiver);
    ...
    function delete_tradeproductsdetails() {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/delete_tradeproductsdetails'; ?>",
            data: {"recnlive": tradeproductsdetailsactive},
            success: function (e) {
...
//                res_text = "ok";
    ...
    function listar_tradeproductsdetails() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/listar_tradeproductsdetails'; ?>",
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function search_comexp() {
        $('#addlicence').removeClass('item-active').addClass('disabled');
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/comexp/Comexp/search'; ?>",
            data: {"name": $('#search_comexp').val()},
            success: function (e) {
                if (e.tradeproducts.length > 0) {
                    ...
                    new PNotify({
                        title: 'Notification',
                        text: "This licence it is not in you record.",
                        shadow: "true",
                        opacity: "0.75",
                        // addclass: noteStack,
                        type: "success",
