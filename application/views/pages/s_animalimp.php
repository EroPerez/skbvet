...
// Funci�n para cargar la licencia anterior.
    function back_licence() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/tradeliveanimal_backward'; ?>",
            data: {"page": $('#page').val()},
            success: function (e) {
//                console.log(e);
                // Limpiar la vista.
...
// Funci�n para cargar la licencia siguiente.
    function forward_licence() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/tradeliveanimal_forward'; ?>",
            data: {"page": $('#page').val()},
            success: function (e) {
//                console.log(e);
                // Limpiar la vista.
...
// Funci�n para salvar los datos de la licencia. Ya sea Insertar nueva o para Actualizar.
    function save_licence() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/tradeliveanimal_add_edit'; ?>",
            data: {
...
// Funci�n para eliminar una licencia.
    function delete_licence() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/tradeliveanimal_delete'; ?>",
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function save_tradeliveanimaldetails() {
        var status = $("input[name='animalimp_status']:checked").val();
        //console.log(status);
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/add_tradeliveanimaldetails'; ?>",
            data: {
                "recntp": $('#recntp').val(),
                "recntpd": $('#recntpd').val(),
                "animalimp_origin": $('#animalimp_origin').val(),
                "animalimp_dateadd": $('#animalimp_dateadd').val(),
                "animalimp_status": status,
    ...
    function editar_tradeliveanimaldetails(idlive) {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/edit_tradeliveanimaldetails'; ?>",
            ...
            success: function (e) {
                ...
                $('#animalimp_breeds').val(e[0].breedRecn);
    ...
    function delete_tradeliveanimaldetails() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/delete_tradeliveanimaldetails'; ?>",
            data: {"recnlive": tradeliveanimaldetailsactive},
            success: function (e) {
    ...
    function listar_tradeliveanimaldetails() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/listar_tradeliveanimaldetails'; ?>",
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function llenar_tabla(lista_animal) {
        ...
        for (i = 0; i < lista_animal.length; i++) {
            var tradeStatus = "New Import";
            if (lista_animal[i].tradeStatus == 2)
                tradeStatus = "Re Import";
            html += "<tr>";
            ...
            html += '<td><a  data-toggle="modal" href="#animalimp_Modal" class="btn btn-primary" id="edit_live_'
                    + lista_animal[i].recntpd + '" onclick="javascript:editar_tradeliveanimaldetails('
    ...
    function exportExcel() {
        ...
        $("#table_animalimp").tableExport({type: 'excel', escape: 'false'});
    }

    function exportPDF() {

        $("#table_animalimp").tableExport({type: 'pdf', pdfFontSize: '7', escape: 'false'});
    }
    ...
    function  search_animimp() {
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/search'; ?>",
            data: {"name": $('#search_animimp').val()},
            success: function (e) {
    ...
    function licence_get_by_id(id, is_edit = true) {
        ...
        jQuery.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo base_url() . 'index.php/animalimp/Animalimp/licence_get_by_id'; ?>",
            data: {"LicRecn": id},
            success: function (e) {
