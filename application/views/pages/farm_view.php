    ...
    <div class="col-md-12">
        <div id="order3" class="admin-form theme-primary">
            ...
            <div class="panel panel-primary panel-border  heading-border">
                                        ...
                                        <div  class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div id="skin-switcher" class="row tray-bin btn-dimmer mb20">
                                                    <div class="col-xs-12 pln"><a id="addfarm" href="javascript:save_farmers();" data-form-skin="primary" class="btn btn-primary btn-gradient btn-alt btn-block disabled"><i class="glyphicon glyphicon-save"></i> Save Farmer</a></div>
                                                    <div class="col-xs-12 pln"><a id="editfarm" href="javascript:edit_farmers();" data-form-skin="primary" class="btn btn-primary btn-gradient btn-alt btn-block disabled"><i class="fa fa-edit"></i> Edit Farmer</a></div>
                                                    <div class="col-xs-12 pln"><a id="deletefarm" href="#" data-toggle="modal" data-target="#delete_modal_farmers" data-form-skin="danger" class="btn btn-success btn-gradient btn-alt btn-block disabled"><i class="fa fa-eraser"></i> Delete Farmer</a></div>
                                                    ...
                                                    <div class="col-xs-12 pln"><a id="listfarm" href="<?= site_url('farm') ?>" data-form-skin="success" class="btn btn-info btn-gradient btn-alt btn-block item-active"><i class="glyphicon glyphicon-list"></i> Back to List</a></div>
                ...
                <div class="row" id="livestockDetails">
                    <div class="col-md-12">

                        <!-- livestock datagrid -->
                        <div class="section row p2">
                            <div class="col-md-12">
                                <div class="gj-margin-top-10"></div>
...
<!-- Modal Eliminar -->
<div class="modal fade" tabindex="-1" id="delete_modal_farmers"  role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><b>Delete Farmer</b></h4>
            </div>
            <div class="modal-body">
                <div class="alert alert-block alert-danger fade in">
                    <h4>Delete this Farmer!!!</h4>
                    <p>Are you sure?</p>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-danger" onclick="javascript:delete_farmers();">Delete</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body admin-form" style="max-height:calc(100vh - 210px); overflow-y: auto;">
                ...
                <form  role="form" id="form-order3" method="post" action="/">    
                    ...
                    <div class="section row" >
                        <div class="col-md-12">
                            ...
                            <label for="livestock_dateadd" class="field prepend-picker-icon">
                                <input id="livestock_dateadd" type="text" name="livestock_dateadd" placeholder="Date Added" class="gui-input">
                            </label>
                        </div>
                    </div>
                    <div class="section row" >
                    ...
                    <div class="section row" >
                        ...
                        <div class="col-md-9">
                            <div class="section-divider"><span>Age</span></div>
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="livestock_yearofbirth" class="field prepend-picker-icon">
                                        <input id="livestock_yearofbirth" type="number" name="livestock_yearofbirth" placeholder="Year of Birth" class="gui-input">
                                    </label>
                                </div>
                                <div class="col-md-6">
                                    <label for="livestock_datebirth" class="field prepend-picker-icon">
                                        <input id="livestock_datebirth" type="number" name="livestock_datebirth" placeholder="Months of Birth" class="gui-input">
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="section row" >
                    <div class="col-md-12">
                        <div class="section-divider"><span>Illness history</span></div>
                        <table id="table_illness_history" class="table">
                            <thead>
                                <tr class="primary">
                                    <th>Illness</th>
            ...
            <div class="modal-footer">
                <!--<button style="float:left" type="button" class="btn btn-info" disabled="true"><i class="fa fa-file"></i> Show documents</button>-->
                <button id="id_illness" style="float:left" type="button" class="btn btn-info" disabled="true" onclick="show_illness()"> <i class="fa fa-medkit"></i> Show Illness</button>
