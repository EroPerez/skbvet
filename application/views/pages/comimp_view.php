                                        ...
                                        <div  class="panel">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div id="skin-switcher" class="row tray-bin btn-dimmer mb20">
                                                    ...
                                                    <div class="col-xs-12 pln"><a id="listfarm" href="<?=site_url('comimp')?>" data-form-skin="success" class="btn btn-info btn-gradient btn-alt btn-block item-active"><i class="glyphicon glyphicon-list"></i> Back to List</a></div>
