...
class User extends CI_Model
{
    ...
    {
        return $this->db->get_where("acl_users", array("id" => $id, "deleted_at" => null))->row(0);
    }
    ...
    public function all()
    {
        return $this->db->get_where("acl_users", array("deleted_at" => null))->result();
    }
    ...
    {
        return $this->db->update('acl_users', $data, array('id' => $data['id']));
    }
    ...
    public function delete($id)
    {
        ...
        return $this->find($id) ? $this->db->update('acl_users', $data, array('id' => $id)) : 0;
    }
    ...
    public function deleteRoles($user_id, $roles)
    {
        ...
        return $this->db->delete('roles_acl_users', array('user_id' => $user_id));
    }
    ...
    public function deleteRole($user_id, $role_id)
    {
        ...
        return $this->db->delete('roles_acl_users', array('user_id' => $user_id, 'role_id' => $role_id));
    }
    ...
    public function userWiseRoles($id)
    {
        return array_map(function($item){
            return $item["role_id"];
        }, $this->db->get_where("roles_acl_users", array("user_id" => $id))->result_array());
    }
