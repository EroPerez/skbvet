...
class Comexp extends My_Controller {
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    function tradeproducts_delete() {
        ...
        $id_tradeproduct = $this->input->post('comimp_recn');

        $id_tradeproductsrecn = $this->M_tradeproducts->del_tradeproducts($id_tradeproduct);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
    ...
    function add_tradeproductsdetails() {
        ...
        $data['d_Consignee_of_sender'] = $this->input->post('comimp_sender');
        $data['d_Consignee_of_receiver'] = $this->input->post('comimp_receiver');
        $res = FALSE;
        if ($this->input->post('edit') == 0) {
