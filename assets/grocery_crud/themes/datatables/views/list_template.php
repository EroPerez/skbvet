<?php
	...
	$this->set_css($this->default_theme_path.'/datatables/css/pnotify.custom.min.css');
	...
	$this->set_js($this->default_theme_path.'/datatables/js/pnotify.custom.min.js');
...
<div class="grocerycrud-container">
	...
	<div class="dataTablesContainer">
		<?php if(!$unset_add){?>
			...
			<a role="button" class="add_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" href="<?php echo $add_url.'/new'?>">
