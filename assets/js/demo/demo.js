...
var Demo = function() {
  ...
  var runDemoSettings = function() {
    ...
    if ($('#skin-toolbox').length) {
      ...
      var headerSkins = "header-light bg-primary bg-success bg-info bg-warning bg-danger bg-alert bg-system bg-dark";
      var sidebarSkins = "sidebar-dark sidebar-default sidebar-light";

      // Theme Settings
      var settingsObj = {
        // 'headerTone': true,
        'headerSkin': 'header-light',
        'sidebarSkin': 'sidebar-default',
        'headerState': 'navbar-fixed-top',
        'sidebarState': 'affix',
        'sidebarAlign': '',
        'breadcrumbState': 'relative',
        'breadcrumbHidden': 'hidden',
      };
