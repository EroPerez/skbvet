...
var demoHighCharts = function () {
  ...
  var highColors = [bgSuccess, bgAlert, bgInfo, bgPrimary, bgWarning, bgDanger, bgSystem, bgDark
  ];
    ...
    var demoHighColumns = function() {
      ...
      if (column3.length) {
        ...
        $('#high-column3').highcharts({
          ...
          series: [{
            name: 'Yahoo',
            data: [7, 6, 9, 14, 18, 21, 26]
          }, {
            name: 'CNN',
            data: [3, 4.2, 5.7, 8.5, 11.9, 15, 28]
          }, {
            name: 'Yahoo',
    ...
    var demoHighAreas = function() {
      ...
      if (area1.length) {
        ...
        $('#high-area').highcharts({
          colors: [bgSuccess, bgDanger, bgInfo],
          credits: false,
          chart: {
            type: 'areaspline',
            spacing: 0,
      ...
      var sparklineInit = function() {
        $('.inlinesparkline').each(function(i, e) {
          ...
          $(e).sparkline('html', {
            ...
            lineColor: Color[0], // Also tooltip icon color
            fillColor: Color[0],
            spotColor: Color[0],
            minSpotColor: Color[0],
            maxSpotColor: Color[0],
            highlightSpotColor: bgWarningLr,
  ...
  var demoCircleGraphs = function() {
    ...
    if (infoCircle.length) {
      ...
      var colors = {
        ...
        "alert": [bgAlert, bgAlertLr, bgAlertDr],
        "paris": ["#fff176", "#fff176", "#fff176"]
      };
      // Store all circles
      var circles = [];
      infoCircle.each(function(i, e) {
        // Define default color
        var color = ['#3482b6', bgPrimary];
